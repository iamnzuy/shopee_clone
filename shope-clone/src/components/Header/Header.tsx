...
export default function Header() {
  ...
  //Chứ không bị unmount - mounting lại lần nữa
  //(Tất nhiên là trừ trường hợp logout rồi nhảy sang registerLayout rồi nhảy vào lại)
  //Nên các Query này sẽ không bị inActivate => Không bị gọi lại => Không cần set staleTime: Infinity
          ...
          <form className='col-span-9' onSubmit={onSubmitSearch}>
            <div className='bg-white rounded-sm p-1 flex'>
              <input
                ...
                {...register('name')}
              />
              <button className='rounded-sm py-2 px-6 flex-shrink-0 bg-orange hover:opacity-90' type='submit'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='none'
                  viewBox='0 0 24 24'
          ...
          <div className='cols-span-1 justify-self-end'>
              ...
              renderPopover={
                <div className='bg-white relative shadow-md rounded-sm border border-gray-200 max-w-[400px] text-sm'>
                  {purchasesIncart ? (
                    <div className='p-2'>
                      ...
                      <div className='mt-5'>
                        {purchasesIncart.slice(0, MAX_PURCHASE).map((item) => {
                          return (
                            <div className='mt-2 py-2 flex hover:bg-gray-100' key={item._id}>
                              ...
                              <div className='ml-2 flex-shrink-0 text-orange'>
                    ...
                    <div className='flex flex-col h-[200px] w-[300px] items-center justify-center p-2'>
            ...
            >
              <Link to={path.home} className='relative'>
                ...
                {purchasesIncart && (
                  <span className='absolute top-[-7px] left-[16px] rounded-full bg-white px-[9px] py-[1px] text-orange'>
