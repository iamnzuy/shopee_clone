...
export default function ProductDetail() {
    ...
    const handleZoom = (
        ...
        //Cách 1: Lấy offsetX, offSetY đơn giản khi xử lý được bubble event (thêm pointer-event-none)
        // const { offsetX, offsetY } = event.nativeEvent;
        //Cách 2: Lấy offsetX, offSetY không cần xử lý bubble event
                            ...
                            <div className="mt-8 flex items-center">
                                <div className="flex items-center">
                                    ...
                                    <ProductRating
                                        ...
                                        activeClassName="w-4 h-4 fill-current text-orange"
